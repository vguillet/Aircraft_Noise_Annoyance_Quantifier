...
%PLOTTING
mesh(xq,yq,vqcorr) %Creates surface.
...
function bndecibels = FFTbns(bnsignal)
[s,f,t] = spectrogram(bnsignal,800,[],[],40000);
T=t.';
F=f;
psd1 = ((t(2)-t(1))^2/t(end))*(abs(s).^2);
bndecibels = 10*log10(psd1/((2*10^(-5))^2));
end
